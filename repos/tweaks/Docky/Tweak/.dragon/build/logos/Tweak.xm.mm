...
@class SBIconListGridLayoutConfiguration; @class SBRootFolderDockIconListView; @class SBDockIconListView; @class SBDockView; @class SBIconController; @class UITraitCollection; 
...
static BOOL _logos_method$Docky$SBDockIconListView$allowsAddingIconCount$(_LOGOS_SELF_TYPE_NORMAL SBDockIconListView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, unsigned long long arg1) {
    if (dockMode == 1 || dockMode == 3) return YES;
    if (dockMode != 0) {
        int count = [[self icons] count];
        return ((arg1 + count) <= [_logos_static_class_lookup$SBRootFolderDockIconListView() maxIcons]);
    }
...
__attribute__((used)) static NSString * _logos_property$iOS13$SBIconListGridLayoutConfiguration$iconLocation(SBIconListGridLayoutConfiguration * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_property$iOS13$SBIconListGridLayoutConfiguration$iconLocation); NSString * rawValue; [value getValue:&rawValue]; return rawValue; };
__attribute__((used)) static void _logos_property$iOS13$SBIconListGridLayoutConfiguration$setIconLocation(SBIconListGridLayoutConfiguration * __unused self, SEL __unused _cmd, NSString * rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(NSString *)]; objc_setAssociatedObject(self, (void *)_logos_property$iOS13$SBIconListGridLayoutConfiguration$iconLocation, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
@interface SBIconController (WorkPlease)

@property(retain, nonatomic) SBIconModel *model;
@end
@interface SBIconModel (work)
...
static void preferencesChanged() 
{
    ...
    if (!constructing) 
        [((SBIconController *)[objc_getClass("SBIconController") sharedInstance]).model layout];
}


static __attribute__((constructor)) void _logosLocalCtor_1479beff(int __unused argc, char __unused **argv, char __unused **envp){	
    preferencesChanged();
